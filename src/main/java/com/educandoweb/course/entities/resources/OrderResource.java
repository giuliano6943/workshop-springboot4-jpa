...
//@RequestMapping(value = "/Orders") -> Define a rota base da API, tudo que estiver dentro dessa classe
//vai responder a URLs que comecem com /Orders
@RestController
...
public class OrderResource {
    ...
    //@GetMapping -> Esse metodo responde a requisição GET na rota /Orders
    @GetMapping
    //É uma reposta HTTP que contém um objeto Order e o status da requisição.
