...
//@RequestMapping(value = "/Products") -> Define a rota base da API, tudo que estiver dentro dessa classe
//vai responder a URLs que comecem com /Products
@RestController
...
public class ProductResource {
    ...
    //@GetMapping -> Esse metodo responde a requisição GET na rota /Products
    @GetMapping
    //É uma reposta HTTP que contém um objeto Product e o status da requisição.
